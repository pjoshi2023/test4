...
class OidcClaimSupportAuthenticatorRequestHandler(private val _config: OidcClaimsSupportAuthenticatorPluginConfig,
    ...
    companion object {
        private val _logger: Logger = LoggerFactory.getLogger(OidcClaimSupportAuthenticatorRequestHandler::class.java)
    }
}
